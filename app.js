$(function(){
  ...
  $("#generate").on('click',function(){
    ...
    var buttonContainer = '<div class=\"container\"><button id=\"delete\">Delete</button><button id=\"change\">Change</button><span id=\"generateClicked' + generateClicked + '\"><span></div>';
